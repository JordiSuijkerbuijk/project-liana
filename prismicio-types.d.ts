...
export interface ProjectsSliceDefaultItem {
  /**
   * Type field in *Projects → Items*
   *
   * - **Field Type**: Select
   * - **Placeholder**: *None*
   * - **API ID Path**: projects.items[].type
   * - **Documentation**: https://prismic.io/docs/field#select
   */
  type: prismic.SelectField<'Proposition' | 'Experimental' | 'Case'>;
 ...
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type VideoSliceSlice = prismic.SharedSlice<'video_slice', VideoSliceSliceVariation>;
...
declare module '@prismicio/client' {
  ...
  namespace Content {
    export type {
      ...
      HeroSliceDefault,
      HighlightedTextSlice,
      HighlightedTextSliceDefaultPrimary,
      HighlightedTextSliceVariation,
